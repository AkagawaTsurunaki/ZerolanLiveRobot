...
class SystemConfig(BaseModel):
    default_enable_microphone: bool = Field(default=False,
                                            description=_("For safety, do not open your microphone by default. \n"
...
class ZerolanLiveRobotConfig(BaseModel):
    pipeline: PipelineConfig = Field(default=PipelineConfig(),
                                     description=_("Configuration for the pipeline settings. \n"
    ...
    service: ServiceConfig = Field(default=ServiceConfig(),
                                   description=_("Configuration for the service settings. \n"
    ...
    character: CharacterConfig = Field(default=CharacterConfig(),
                                       description=_("Configuration for the character settings."))
    system: SystemConfig = Field(default=SystemConfig(), description=_("Configuration for the system settings."))
